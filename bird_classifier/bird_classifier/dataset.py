...
class BirdSoundDataset(Dataset):
	def __init__(self, 
		...
		"""
		Initialize a BirdSoundDataset object.
		...
		recordings_path : Path
			The path to the folder containing the recordings
		mode : str, optional
			The mode of the dataset, one of 'train', 'valid', or 'test'
		sr : int, optional
			The sample rate of the recordings
		duration : float, optional
			The duration of the samples in seconds
		preprocess_fn : Callable, optional
			A preprocessing function to apply to the samples
		time_augment_fn : Callable, optional
			A time domain augmentation function to apply to the samples
		spec_augment_fn : Callable, optional
			A spectral domain augmentation function to apply to the samples

		Raises
		------
		ValueError
			If the mode is not 'train', 'valid', or 'test'
		"""
